...
<head>
    ...
    <title>UNSRI | Daftar Kriteria</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                ...
                                <table id="mytable" class="table table-striped table-bordered table-hover text-center" align="center">
                                    <thead>
                                        <tr>
                                            <td>Nama Kriteria</td>
                                            <td>Kaidah</td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $k['tipe_preferensi'].' - '.$k['nama_preferensi']; ?></td>
                                            <td>
                                                <button class="btn btn-info dim" onclick="location.href='<?php echo site_url('daftar_kriteria/edit_kriteria/'.$k['id_kriteria'])?>'" type="button"><i class="fa fa-edit"></i></button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
