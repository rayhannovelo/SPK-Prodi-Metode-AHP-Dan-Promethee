                    ...
                    <div class="col-md-12">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <h5>Form Edit Program Studi</h5>
                            </div>
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <?php if($prodi != NULL) foreach ($prodi as $p) { ?>
                                        <form class="form-horizontal" role="form" action="<?php echo site_url('daftar_prodi/edit_prodi_form/'.$p['id_prodi'])?>" method="post">
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Nama Program Studi :</label>
                                            <div class="col-lg-9">
                                                <input type="text" name="nama_prodi" placeholder="Nama Program Studi" class="form-control" value="<?php echo $p['nama_prodi']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <select name="id_akreditasi" class="form-control">
                                                    ...
                                                    <option value="<?php echo $a['id_akreditasi'] ?>" <?php if($a['id_akreditasi'] == $p['id_akreditasi']){ echo 'selected'; }?>><?php echo $a['nama_akreditasi']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <select name="id_pelajaran" class="form-control">
                                                    ...
                                                    <option value="<?php echo $mp['id_pelajaran'] ?>" <?php if($mp['id_pelajaran'] == $p['id_pelajaran']){ echo 'selected'; }?>><?php echo $mp['nama_pelajaran']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <select name="id_minat" class="form-control">
                                                    ...
                                                    <option value="<?php echo $m['id_minat'] ?>" <?php if($m['id_minat'] == $p['id_minat']){ echo 'selected'; }?>><?php echo $m['nama_minat']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <select name="id_cita_cita" class="form-control">
                                                    ...
                                                    <option value="<?php echo $m['id_cita_cita'] ?>" <?php if($m['id_cita_cita'] == $p['id_cita_cita']){ echo 'selected'; }?>><?php echo $m['nama_cita_cita']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
